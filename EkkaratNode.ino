...
void t2CallsendViaNBIOT_secondSend();
void t4Restart();
//TASK
Task t1(10000, TASK_FOREVER, &t1CallgetMeter);
Task t2(15000, TASK_FOREVER, &t2CallsendViaNBIOT);
Task t3(30000, TASK_FOREVER, &t2CallsendViaNBIOT_secondSend);
...
void setup()
{
  ...
  Serial.begin(115200);
  SerialBT.begin("Ekarat308419"); //Bluetooth device name
  SerialBT.println("Ekarat308419");
...
void readMeter()
{
  ...
  meter.di1 = read_Modbus_1Byte(ID_Drycontact, DI1);
  meter.di2 = read_Modbus_1Byte(ID_Drycontact, DI2);
  meter.di3 = read_Modbus_1Byte(ID_Drycontact, DI3);
  meter.di4 = read_Modbus_1Byte(ID_Drycontact, DI4);
  ...
  Serial.print("DryContact1: ");
  Serial.println(meter.di1);
  Serial.print("DryContact2: ");
  Serial.println(meter.di2);
  Serial.print("DryContact3: ");
  Serial.println(meter.di3);
  Serial.print("DryContact4: ");
  Serial.println(meter.di4);
